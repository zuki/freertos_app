...
#define SPI0_CSN_PIN         17
#define SPI0_DCN_PIN         20
#define SPI0_RESN_PIN        21
...
#define CS0_SELECT       gpio_put(SPI0_CSN_PIN, false)
#define CS0_DESELECT     gpio_put(SPI0_CSN_PIN, true)
#define DC0_COMMAND      gpio_put(SPI0_DCN_PIN, false)
#define DC0_DATA         gpio_put(SPI0_DCN_PIN, true)
#define RESET0_ON        gpio_put(SPI0_RESN_PIN, false)
#define RESET0_OFF       gpio_put(SPI0_RESN_PIN, true)
